...
from PPO_alone import PPOAgent
...
from Utils.DFOPS_V2 import DFOPS
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='MHPAC_max_new_sim')
    ...
    parser.add_argument("--rew_kl", type=float, default=1e-5, help="kl reward weight")
